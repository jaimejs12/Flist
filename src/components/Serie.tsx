      ...
      <div className="p-4 sm:w-1/2 lg:w-1/3 mx-auto">
        <div className='h-full relative m-0 shadow-lg flex bg-#141414 border-2 border-gray-200 border-opacity-60 rounded-lg ease-linear transform hover:scale-105 transition duration-200'>
          <div className='flex-no-shrink'>
            <img alt='' className='lg:h-72 md:h-48 sm:h-56 w-full block object-cover mx-auto rounded-md' src='https://images.justwatch.com/poster/255388636/s276/arcane.webp' />
          </div>
            ...
            <div className="p-6">
              ...
              <div className='py-2 border-t border-b text-xs'>
                ...
                <span className='flex iems-center'>
                  <img className='h-4 w-4 rounded-md' src={netflixIcon} />
                  <img className='h-4 w-4 ml-2 rounded-md' src={hboIcon} />
                </span>
              </div>
              <div className='pt-5 text-sm'>
                <button className='w-max border-2 hover:bg-gray-400 border-gray-200 hover:text-black rounded'>
